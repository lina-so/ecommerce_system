@extends('admin.layouts_dashboard.master2')
@section('css')
											...
											<div class="main-signup-header">
												...
												<form action="{{ url('admin/signin') }}" method="post">
													<div class="form-group">
														<label>Email</label>
														<input type="email" name="email" id="email" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="E-mail" required="">
													</div>
													<div class="form-group">
