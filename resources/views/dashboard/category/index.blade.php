...
@section('content')
        ...
        @if(session()->has('update'))
            ...
            notif({
            msg:"classification update successfuly",
            type:"success"
            })
            }
            </script>
										...
										<div id="collapseThree{{$i}}" class="collapse b-b0 bg-white" aria-labelledby="headingThree" data-parent="#accordion">
											<div class="border p-3">
												<table class="table mb-0 table-bordered border-top mb-0">
                                                    ...
                                                    @foreach ($category->classifications as $list_Sections)
                                                        ...
                                                        <div class="modal" id="modaldemo9{{$list_Sections->id}}">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content modal-content-demo">
                                                                    ...
                                                                    <form action="{{route('classification.update',$list_Sections->id)}}" method="post">
                                                                            {{method_field('patch')}}
                                                                            {{csrf_field()}}
