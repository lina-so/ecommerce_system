                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-6">
                            ...
                            <div class="mobile-logo text-center">
                                <a href="index.html"><img src="assets2/images/logo.svg" alt="Logo"></a>
                            </div>
                            <!-- desktop logo Ends -->
                        </div>
                        <div class="col-3">
                            ...
                            <div class="navbar-cart">
                                <a class="icon-btn primary-icon-text icon-text-btn" href="javascript:void(0)">
                                    <img src="assets2/images/icon-svg/cart-1.svg" alt="Icon">
                                                ...
                                                <tbody>
                                                        ...
                                                        <td class="checkout-product">
                                                            <div class="product-cart d-flex">
                                                                <div class="product-thumb">
                                                                    <img src="assets2/images/product-cart/product-1.png"
                                                                        alt="Product">
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td class="checkout-product">
                                                            <div class="product-cart d-flex">
                                                                <div class="product-thumb">
                                                                    <img src="assets2/images/product-cart/product-2.png"
                                                                        alt="Product">
                                                                </div>
                                                                <div class="product-content media-body">
                                                                    <h5 class="title">
                                                    ...
                                                    <tr>
                                                        <td class="checkout-product">
                                                            <div class="product-cart d-flex">
                                                                <div class="product-thumb">
                                                                    <img src="assets2/images/product-cart/product-3.png"
                                                                        alt="Product">
                                                                </div>
                                                                <div class="product-content media-body">
                                                                    <h5 class="title">
                                                    ...
                                                    <tr>
                                                        <td class="checkout-product">
                                                            <div class="product-cart d-flex">
                                                                <div class="product-thumb">
                                                                    <img src="assets2/images/product-cart/product-4.png"
                                                                        alt="Product">
                                                                </div>
                                                                <div class="product-content media-body">
                                                                    <h5 class="title">
                                                ...
                                                <div class="mega-dropdown-menu">
                                                    <ul class="container mega-dropdown d-flex flex-wrap">
                                                        ...
                                                        <li class="mega-dropdown-list">
                                                            <img src="assets2/images/menu-slider-1.png" alt="">
                                                        </li>
                                                    </ul>
                                                </div>
                                            </li>
    ...
    <section class="header-style-1">
        <div class="header-big">
            <div class="header-items-active">
                <div class="single-header-item bg_cover"
                    style="background-image: url(assets2/images/header-1/header-big-1.jpg);">
                ...
                <div class="single-header-item bg_cover"
                    style="background-image: url(assets2/images/header-1/header-big-2.jpg);">
                    <div class="header-item-content">
                        <h3 class="title">Don’t say it with flowers: A NOMOS watch is a gift that lasts</h3>
                        <a href="javascript:void(0)" class="link">Our Valentine's Day collection</a>
                    </div>
        ...
        <div class="header-min">
            <div class="header-min-item product-style-25 bg_cover"
                style="background-image: url(assets2/images/header-1/header-min-1.jpg);">
                <div class="product-content">
                    <h4 class="title"><a href="product-details-page.html">Metro 38 Date</a></h4>
                    <p>Reference 1102</p>
                    <a href="javascript:void(0)" class="main-btn primary-btn-border"> <img src="assets2/images/icon-svg/cart-5.svg" alt="">$
                        399</a>
                </div>
            </div>
            <div class="header-min-item product-style-25 bg_cover"
                style="background-image: url(assets2/images/header-1/header-min-2.jpg);">
                <div class="product-content">
                    <h4 class="title"><a href="product-details-page.html">Metro 38 Date</a></h4>
                    <p>Reference 1102</p>
                    <a href="javascript:void(0)" class="main-btn primary-btn-border"> <img src="assets2/images/icon-svg/cart-5.svg" alt="">$
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="product-style-1 mt-30">
                        <div class="product-image">
                            ...
                            <div class="product-active">
                                <div class="product-item active">
                                    <img src="assets2/images/product-1/product-5.jpg" alt="product">
                                </div>
                                <div class="product-item">
                                    <img src="assets2/images/product-1/product-6.jpg" alt="product">
                                </div>
                            </div>
                            <a class="add-wishlist" href="javascript:void(0)">
                                <i class="mdi mdi-heart-outline"></i>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="product-style-1 mt-30">
                        <div class="product-image">
                            <div class="product-active">
                                <div class="product-item active">
                                    <img src="assets2/images/product-1/product-3.jpg" alt="product">
                                </div>
                                <div class="product-item">
                                    <img src="assets2/images/product-1/product-4.jpg" alt="product">
                                </div>
                            </div>
                            <a class="add-wishlist" href="javascript:void(0)">
                                <i class="mdi mdi-heart-outline"></i>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="product-style-1 mt-30">
                        <div class="product-image">
                            <div class="product-active">
                                <div class="product-item active">
                                    <img src="assets2/images/product-1/product-7.jpg" alt="product">
                                </div>
                                <div class="product-item">
                                    <img src="assets2/images/product-1/product-8.jpg" alt="product">
                                </div>
                            </div>
                            <a class="add-wishlist" href="javascript:void(0)">
                                <i class="mdi mdi-heart-outline"></i>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="product-style-1 mt-30">
                        <div class="product-image">
                            <div class="product-active">
                                <div class="product-item active">
                                    <img src="assets2/images/product-1/product-9.jpg" alt="product">
                                </div>
                                <div class="product-item">
                                    <img src="assets2/images/product-1/product-10.jpg" alt="product">
                                </div>
                            </div>
                            <a class="add-wishlist" href="javascript:void(0)">
                                <i class="mdi mdi-heart-outline"></i>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="product-style-1 mt-30">
                        <div class="product-image">
                            ...
                            <div class="product-active">
                                <div class="product-item active">
                                    <img src="assets2/images/product-1/product-11.jpg" alt="product">
                                </div>
                                <div class="product-item">
                                    <img src="assets2/images/product-1/product-12.jpg" alt="product">
                                </div>
                            </div>
                            <a class="add-wishlist" href="javascript:void(0)">
                                <i class="mdi mdi-heart-outline"></i>
                ...
                <div class="col-lg-6">
                    <div class="product-style-7 mt-30">
                        <div class="product-image">
                            <div class="product-active">
                                <div class="product-item active">
                                    <img src="assets2/images/product-4/product-1.jpg" alt="product">
                                </div>
                                <div class="product-item">
                                    <img src="assets2/images/product-4/product-2.jpg" alt="product">
                                </div>
                            </div>
                        </div>
                        <div class="product-content">
                            ...
                            <a href="javascript:void(0)" class="main-btn primary-btn">
                                <img src="assets2/images/icon-svg/cart-4.svg" alt="">
                                Add to Cart
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="product-style-7 mt-30">
                        <div class="product-image">
                            <div class="product-active">
                                <div class="product-item active">
                                    <img src="assets2/images/product-4/product-3.jpg" alt="product">
                                </div>
                                <div class="product-item">
                                    <img src="assets2/images/product-4/product-4.jpg" alt="product">
                                </div>
                            </div>
                        </div>
                        <div class="product-content">
                ...
                <div class="col-lg-6">
                    <div class="product-style-7 mt-30">
                        <div class="product-image">
                            ...
                            <div class="product-active">
                                <div class="product-item active">
                                    <img src="assets2/images/product-4/product-5.jpg" alt="product">
                                </div>
                                <div class="product-item">
                                    <img src="assets2/images/product-4/product-6.jpg" alt="product">
                                </div>
                            </div>
                        </div>
                        <div class="product-content">
                ...
                <div class="col-lg-6">
                    <div class="product-style-7 mt-30">
                        <div class="product-image">
                            <div class="product-active">
                                <div class="product-item active">
                                    <img src="assets2/images/product-4/product-7.jpg" alt="product">
                                </div>
                                <div class="product-item">
                                    <img src="assets2/images/product-4/product-8.jpg" alt="product">
                                </div>
                            </div>
                        </div>
                        <div class="product-content">
                ...
                <div class="col-lg-6">
                    <div class="product-style-7 mt-30">
                        <div class="product-image">
                            <div class="product-active">
                                <div class="product-item active">
                                    <img src="assets2/images/product-4/product-9.jpg" alt="product">
                                </div>
                                <div class="product-item">
                                    <img src="assets2/images/product-4/product-10.jpg" alt="product">
                                </div>
                            </div>
                        </div>
                        <div class="product-content">
                ...
                <div class="col-lg-6">
                    <div class="product-style-7 mt-30">
                        <div class="product-image">
                            ...
                            <div class="product-active">
                                <div class="product-item active">
                                    <img src="assets2/images/product-4/product-11.jpg" alt="product">
                                </div>
                                <div class="product-item">
                                    <img src="assets2/images/product-4/product-12.jpg" alt="product">
                                </div>
                            </div>
                        </div>
                        <div class="product-content">
            ...
            <div class="row client-logo-active">
                <div class="col-lg-3">
                    <div class="single-logo-wrapper">
                        <img src="assets2/images/client-logo/uideck-logo.svg" alt="">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="single-logo-wrapper">
                        <img src="assets2/images/client-logo/graygrids-logo.svg" alt="">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="single-logo-wrapper">
                        <img src="assets2/images/client-logo/lineicons-logo.svg" alt="">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="single-logo-wrapper">
                        <img src="assets2/images/client-logo/pagebulb-logo.svg" alt="">
                    </div>
                </div>
            </div>
        </div>
